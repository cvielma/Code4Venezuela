...
/**
 * Downloads the tweets with the search criteria and appends them into the tweets.json file in the build directory
 */
public class TwitterConnectUtil {
    ...
    public static void main(String... args) throws IOException, InterruptedException, ExecutionException {
        TwitterConnectUtil main = new TwitterConnectUtil();
